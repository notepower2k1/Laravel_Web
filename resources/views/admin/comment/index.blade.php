...
@section('pageTitle', 'Danh sách bình luận')
@section('content')
      ...
      <div class="filter-box">
        ...
        <div class="button-box">
            <button class="btn btn-dim btn-warning" id="filter-btn">
              ...
              @if(isset($fromDate))
              <a class="btn btn-dim btn-info" href="/admin/comment">
...
<script>
  ...
  $('#filter-btn').click(function() {
    ...
    if(fromDate && toDate){
      window.location.href = `/admin/comment/filter/${customFormatDate(fromDate)}/${customFormatDate(toDate)}`;
    }
