...
@section('pageTitle', 'Danh sách tài liệu đã xóa')
            ...
            <div class="filter-box">
                ...
                <div class="button-box">
                    <button class="btn btn-dim btn-warning" id="filter-btn">
                      ...
                      @if(isset($fromDate))
                      <a class="btn btn-dim btn-info" href="/admin/deleted/document">
                ...
                <tbody>
                    ...
                    <tr class="nk-tb-item" id ="row-{{ $document->id }}">
                        <td class="nk-tb-col nk-tb-col-check">
                            <div class="custom-control custom-control-sm custom-checkbox notext">
                                <input type="checkbox" name='selection' class="custom-control-input" id="uid-document-{{ $document->id }}" data-id="{{ $document->id }}">
                                <label class="custom-control-label" for="uid-book-{{ $document->id }}"></label>
                            </div>
                        </td> 
...
<script>
  ...
  $('#filter-btn').click(function() {
    ...
    if(fromDate && toDate){
      window.location.href = `/admin/deleted/document/filter/${customFormatDate(fromDate)}/${customFormatDate(toDate)}`;
    }
