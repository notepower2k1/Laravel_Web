...
@section('content')
                    <div class="nk-block nk-block-lg">
                        <div class="nk-block-head">
                            ...
                            <a href="/quan-ly/them-sach" class="btn btn-primary">Thêm truyện</a>                           
                            </div>
                        </div>
                                      ...
                                      @foreach ($books as $book)
                                        ...
                                        <tr class="nk-tb-item" id ="row-{{ $book->id }}">
                                            ...
                                            <td class="nk-tb-col tb-col-lg">
                                              <img class="image-fluid" src={{ asset ('storage/'.$book->image) }} alt="..." style="width:100px" />
                                            </td>
                                            <td class="nk-tb-col">
                                                <div class="user-card">                                           
                                                    <div class="user-info">
                                                      ...
                                                      <div class="drodown">
                                                          ...
                                                          <div class="dropdown-menu dropdown-menu-end">
                                                              <ul class="link-list-opt no-bdr">
                                                                  ...
                                                                  <li><a href="/quan-ly/cap-nhat-sach/{{$book->id}}"><em class="icon ni ni-edit"></em><span>Cập nhật</span></a></li>
                                                                  <li class="divider"></li>
