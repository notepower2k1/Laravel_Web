                ...
                <div class="card-inner">               
                            ...
                            <div class="nk-tb-item">   
                                <div class="nk-tb-col tb-col-sm">
                                    <span class="tb-product">
                                        ...
                                        <a href="/sach/{{ $book->id}}/{{ $book->slug }}"><span class="fw-bold">{{ $book->name }}</span></a>
                                    </span>
                                </div>
                                <div class="nk-tb-col">
                    ...
                    <div class="nk-block">
                        ...
                        <div class="nk-tb-list nk-tb-ulist is-compact border round-sm">
                            ...
                            <div class="nk-tb-item">
                                <div class="nk-tb-col">
                                    <a href="/tai-lieu/{{ $document->id}}/{{ $document->slug }}"><span class="fw-bold">{{ $document->name }}</span></a>
                                </div>                         
                                <div class="nk-tb-col">
                            ...
                            <div class="card-inner">
                                <div class="between-center flex-wrap flex-md-nowrap g-3">
                                    ...
                                    <div class="nk-block-actions flex-shrink-0">
                                        <a href="#" class="btn btn btn-danger">Gửi</a>
                                    </div>
                                </div>
                            </div><!-- .nk-card-inner -->
                        </div><!-- .nk-card -->
